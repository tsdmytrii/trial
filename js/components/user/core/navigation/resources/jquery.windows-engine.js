...
jQuery.extend({
    ...
    newWindow: function(options) {
        ...
        $windowOverlay = $('<div class="window-overlay">Component is loading</div>');
        ...
        if(options.overlay){
            ...
            $windowContainer.append($windowOverlay);
        ...
        /*$windowCloseButton.bind('click', function(e) {
            ...
            delete_button($window); // deleting button from the toolbar
        });*/
