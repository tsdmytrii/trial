...
RTOOLBAR['default'] =
{
	...
	styles:
	{
		...
		dropdown:
	    {
			 ...
			 _h2:
			 {
			 	title: RLANG.header2h,
			 	exec: 'formatblock',
			 	param: '<h2 style="color: #AD2118">',
			 	style: 'font-size: 24px; line-height: 36px; font-weight: normal;'
			 },
			 h3:
			 {
			 ...
			 _h3:
			 {
			 	title: RLANG.header3h,
			 	exec: 'formatblock',
			 	param: '<h3 style="color: #AD2118">',
			 	style: 'font-size: 20px; line-height: 30px;  font-weight: normal;'
			 },
			 h4:
			 {
			 ...
			 _h4:
			 {
			 	title: RLANG.header4h,
			 	exec: 'formatblock',
			 	param: '<h4 style="color: #AD2118">',
			 	style: 'font-size: 16px; line-height: 26px;  font-weight: normal;'
			 }
		},
		separator: true
